...
variable "tectonic_container_images" {
  ...
  default = {
    ...
    tnc_operator                         = "quay.io/coreos/tectonic-node-controller-operator-dev:e2a378c045af5d226702e9c8ec57bde6fc619fda"
    ...
    kube_addon_operator                  = "quay.io/coreos/kube-addon-operator-dev:c604bcefbe4ac1705309132efb3c9b1e6aa6cc66"
    ...
    tectonic_utility_operator            = "quay.io/coreos/tectonic-utility-operator-dev:f49d28f3386aedf7085213d21b64eff55bc511d5"
