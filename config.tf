...
variable "tectonic_container_images" {
  ...
  default = {
    ...
    tnc_operator                         = "quay.io/coreos/tectonic-node-controller-operator-dev:a40c52f09cb4836585913dca99ce0264d2ef747d"
    ...
    kube_core_renderer                   = "quay.io/coreos/kube-core-renderer-dev:a3a41151695be0ddca6e9fce463d14ee64275d88"
    kube_core_operator                   = "quay.io/coreos/kube-core-operator-dev:a3a41151695be0ddca6e9fce463d14ee64275d88"
